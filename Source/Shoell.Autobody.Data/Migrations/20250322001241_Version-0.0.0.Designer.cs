...
namespace Shoell.Autobody.Data.Migrations
{
    ...
    [Migration("20250322001241_Version-0.0.0")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Company.Project.Models.Identity.Group", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Company.Project.Models.Identity.Role", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Company.Project.Models.Identity.Role_Group", b =>
                {
            ...
            modelBuilder.Entity("Company.Project.Models.Identity.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Company.Project.Models.Identity.User_Group", b =>
                {
            ...
            modelBuilder.Entity("Company.Project.Models.Identity.User_Role", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Company.Project.Models.System.Log", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Company.Project.Models.Identity.Group", b =>
                {
                    b.HasOne("Company.Project.Models.Identity.User", "ArchivedBy")
                        .WithMany()
                        .HasForeignKey("ArchivedById")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("Company.Project.Models.Identity.User", "CreatedBy")
                        .WithMany()
                        .HasForeignKey("CreatedById")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Company.Project.Models.Identity.User", "DeletedBy")
                        .WithMany()
                        .HasForeignKey("DeletedById")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("Company.Project.Models.Identity.User", "ModifiedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("Company.Project.Models.Identity.Role_Group", b =>
                {
                    b.HasOne("Company.Project.Models.Identity.Group", "Group")
                        .WithMany("RoleGroups")
                        .HasForeignKey("GroupId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Company.Project.Models.Identity.Role", "Role")
                        .WithMany("RoleGroups")
            ...
            modelBuilder.Entity("Company.Project.Models.Identity.User_Group", b =>
                {
                    ...
                    b.HasOne("Company.Project.Models.Identity.User", "User")
                        .WithMany("UserGroups")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("Company.Project.Models.Identity.Role", null)
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("Company.Project.Models.Identity.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
